...
const PDFViewerApplication = {
  ...
  async close() {
    var _this$pdfSidebar, _this$pdfOutlineViewe, _this$pdfAttachmentVi, _this$pdfLayerViewer, _this$pdfHistory, _this$findBar, _this$toolbar, _this$secondaryToolba, _this$_PDFBug;
  ...
  progress(level) {
    ...
    if (((_this$pdfDocument2 = this.pdfDocument) === null || _this$pdfDocument2 === void 0 ? void 0 : _this$pdfDocument2.loadingParams.disableAutoFetch) ?? _app_options.AppOptions.get("disableAutoFetch")) {
  ...
  load(pdfDocument) {
    ...
    this.pdfLinkService.setDocument(pdfDocument, (0, _pdfjsLib.isDataScheme)(baseUrl) ? null : baseUrl);
...
function webViewerPageNumberChanged(evt) {
  ...
  if (evt.value !== pdfViewer.currentPageNumber.toString() && evt.value !== pdfViewer.currentPageLabel) {
    ...
    (_PDFViewerApplication12 = PDFViewerApplication.toolbar) === null || _PDFViewerApplication12 === void 0 ? void 0 : _PDFViewerApplication12.setPageNumber(pdfViewer.currentPageNumber, pdfViewer.currentPageLabel);
  }
}
...
function webViewerDocumentProperties() {
  ...
  (_PDFViewerApplication13 = PDFViewerApplication.pdfDocumentProperties) === null || _PDFViewerApplication13 === void 0 ? void 0 : _PDFViewerApplication13.open();
}
...
function webViewerUpdateFindControlState(_ref12) {
  ...
  if (PDFViewerApplication.supportsIntegratedFind) {
    ...
    (_PDFViewerApplication14 = PDFViewerApplication.findBar) === null || _PDFViewerApplication14 === void 0 ? void 0 : _PDFViewerApplication14.updateUIState(state, previous, matchesCount);
  }
}
function webViewerScaleChanging(evt) {
  var _PDFViewerApplication15;
  (_PDFViewerApplication15 = PDFViewerApplication.toolbar) === null || _PDFViewerApplication15 === void 0 ? void 0 : _PDFViewerApplication15.setPageScale(evt.presetValue, evt.scale);
...
function webViewerPageChanging(_ref13) {
  var _PDFViewerApplication16, _PDFViewerApplication17, _PDFViewerApplication18, _PDFViewerApplication20;
  let {
    pageNumber,
    pageLabel
  } = _ref13;
  (_PDFViewerApplication16 = PDFViewerApplication.toolbar) === null || _PDFViewerApplication16 === void 0 ? void 0 : _PDFViewerApplication16.setPageNumber(pageNumber, pageLabel);
  (_PDFViewerApplication17 = PDFViewerApplication.secondaryToolbar) === null || _PDFViewerApplication17 === void 0 ? void 0 : _PDFViewerApplication17.setPageNumber(pageNumber);
  if (((_PDFViewerApplication18 = PDFViewerApplication.pdfSidebar) === null || _PDFViewerApplication18 === void 0 ? void 0 : _PDFViewerApplication18.visibleView) === _ui_utils.SidebarView.THUMBS) {
    var _PDFViewerApplication19;
    (_PDFViewerApplication19 = PDFViewerApplication.pdfThumbnailViewer) === null || _PDFViewerApplication19 === void 0 ? void 0 : _PDFViewerApplication19.scrollThumbnailIntoView(pageNumber);
  }
  const currentPage = PDFViewerApplication.pdfViewer.getPageView(pageNumber - 1);
  (_PDFViewerApplication20 = PDFViewerApplication.toolbar) === null || _PDFViewerApplication20 === void 0 ? void 0 : _PDFViewerApplication20.updateLoadingIndicatorState((currentPage === null || currentPage === void 0 ? void 0 : currentPage.renderingState) === _ui_utils.RenderingStates.RUNNING);
}
...
function webViewerClick(evt) {
  var _PDFViewerApplication21, _appConfig$toolbar3, _appConfig$secondaryT5;
  if (!((_PDFViewerApplication21 = PDFViewerApplication.secondaryToolbar) !== null && _PDFViewerApplication21 !== void 0 && _PDFViewerApplication21.isOpen)) {
    return;
  }
...
function webViewerKeyDown(evt) {
  var _PDFViewerApplication23, _PDFViewerApplication24, _PDFViewerApplication25, _PDFViewerApplication26, _PDFViewerApplication27;
    ...
    switch (evt.keyCode) {
      case 70:
        if (!PDFViewerApplication.supportsIntegratedFind && !evt.shiftKey) {
          ...
          (_PDFViewerApplication22 = PDFViewerApplication.findBar) === null || _PDFViewerApplication22 === void 0 ? void 0 : _PDFViewerApplication22.open();
          handled = true;
        }
        break;
      case 71:
  ...
  if (cmd === 0) {
    ...
    switch (evt.keyCode) {
      ...
      case 80:
        ...
        break;
      case 27:
        if ((_PDFViewerApplication23 = PDFViewerApplication.secondaryToolbar) !== null && _PDFViewerApplication23 !== void 0 && _PDFViewerApplication23.isOpen) {
          PDFViewerApplication.secondaryToolbar.close();
          handled = true;
        }
        if (!PDFViewerApplication.supportsIntegratedFind && (_PDFViewerApplication24 = PDFViewerApplication.findBar) !== null && _PDFViewerApplication24 !== void 0 && _PDFViewerApplication24.opened) {
      ...
      case 35:
        ...
        break;
      case 83:
        (_PDFViewerApplication25 = PDFViewerApplication.pdfCursorTools) === null || _PDFViewerApplication25 === void 0 ? void 0 : _PDFViewerApplication25.switchTool(_ui_utils.CursorTool.SELECT);
        break;
      case 72:
        (_PDFViewerApplication26 = PDFViewerApplication.pdfCursorTools) === null || _PDFViewerApplication26 === void 0 ? void 0 : _PDFViewerApplication26.switchTool(_ui_utils.CursorTool.HAND);
        break;
      case 82:
        PDFViewerApplication.rotatePages(90);
        break;
      case 115:
        (_PDFViewerApplication27 = PDFViewerApplication.pdfSidebar) === null || _PDFViewerApplication27 === void 0 ? void 0 : _PDFViewerApplication27.toggle();
        break;
    }
...
class PDFHistory {
  ...
  _pushOrReplaceState(destination) {
    ...
    if ((_window$history$state = window.history.state) !== null && _window$history$state !== void 0 && _window$history$state.chromecomState) {
  ...
  _popState(_ref5) {
    ...
    if (state !== null && state !== void 0 && state.chromecomState && !this._isValidState(state) || !state) {
      this._uid++;
      const {
        hash,
        page,
